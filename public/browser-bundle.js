...
/***/ function(module, exports, __webpack_require__) {
	...
	var Categories = __webpack_require__(159);
	...
	ReactDOM.render(React.createElement(HelloMessage, {name: "John"}), document.querySelector('#mount-point'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CategoryEntry = __webpack_require__(161);
	...
	module.exports = React.createClass({displayName: "module.exports",
	  ...
	  renderEntry: function(c, idx) {
	    return React.createElement(CategoryEntry, {
	              name: c, 
	              key: idx, 
	              id: idx, 
	  ...
	  render: function() {
	    return React.createElement("div", {className: "category-container"}, 
	      React.createElement("h2", null, "SciFi Books in Kindle and Hard Cover version"), 
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({displayName: "module.exports",
	    ...
	    if (this.props.active) {
	      return React.createElement("ul", null, 
	        this.state.books.map(function(b) {
	          return React.createElement("li", null, React.createElement("b", null, b.title), " by ", b.author);
	        })
	      );
	    }
	  },
	  ...
	  render: function() {
	    return React.createElement("li", {className: "category-container__entry"}, 
	      this.props.name, 
	      this.props.types.map(function(v) {
	        var cb = this.loadBooks.bind(this, v.link);
	        return React.createElement("a", {href: v.link, onClick: cb}, 
	          "(", v.title, ")"
	        );
	      }.bind(this)), 
	      this.renderBooks()
